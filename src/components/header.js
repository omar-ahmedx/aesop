    ...
    <div>
      <div className="announcement-container">
        <p className="announcement-text">
          Now shipping all across the UAE. Same day delivery before 6pm in Dubai
          only. Free shipping on orders over 300 AED
        </p>
      </div>
      <nav className="nav-mobile">
        <div>
          <a href="#" className="navLogo-mobile">
            <svg
              className="svg"
              aria-labelledby="7f287fc4-e2fd-4536-9fdd-d9839b1b5c52"
              role="img"
              viewBox="0 0 489.7 154.3"
            >
              <title id="7f287fc4-e2fd-4536-9fdd-d9839b1b5c52">
                Aesop logo
              </title>
              <g>
                <path
        ...
        <header>
          <nav className="nav-desk">
            <div>
              <button type="button" className="nav-btn">
                Shop
                <svg viewBox="0 0 9 9" className="header-icon">
                  <path
          ...
          <div className="introduction">
            <h2 className="intro-h2">Introducing the Geranium Leaf Range</h2>
            <p>
              Invigorating blend of botanicals formulated to hydrate and nourish
              your skin
            </p>
            <butto type="button" className="discover-btn">
              Discover more
            </butto>
          </div>
